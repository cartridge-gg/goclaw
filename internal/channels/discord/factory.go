...
type discordInstanceConfig struct {
	...
	AutoRespondExcludedParentChannelIDs []string `json:"auto_respond_excluded_parent_channel_ids,omitempty"`
...
func buildChannel(name string, creds json.RawMessage, cfg json.RawMessage,
	...
	dcCfg := config.DiscordConfig{
		...
		AutoRespondExcludedParentChannelIDs: ic.AutoRespondExcludedParentChannelIDs,
